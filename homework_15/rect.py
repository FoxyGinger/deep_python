    ...
    def inner(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            for kwarg_value in kwargs.values():
                if kwarg_value.__class__.__name__ != class_name:
                    raise InvalidObject
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--area', action='append_const', dest='commands', const='area', help="get area of the rectangle")
    parser.add_argument('-p', '--perimeter', action='append_const', dest='commands', const='perimeter', help="get perimeter of the rectangle")
